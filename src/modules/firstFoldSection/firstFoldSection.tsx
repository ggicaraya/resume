  ...
  return (
    <div className={cn(`section relative firstFoldSection ${className}`)} ref={sectionRef}>
      ...
      >
        ...
        <div className="shadow-xl relative z-10">
          <div className="bg-[#162022] p-6 rounded-t-3xl w-full max-w-3xl -mb-6">
            <div>
              <Image
                ...
                src="/images/white-diamond-dark.png"
                unoptimized
                loading="lazy"
              />
            </div>
          ...
          <div className="flex flex-col max-w-3xl rounded-b-3xl px-6 py-6 relative overflow-hidden bg-[#0E161B]">
            ...
            <div>
              <div className={`flex justify-end relative z-10 -mr-2 sm:mr-0 -mt-5 ${isVisible ? "animate-slideInRight opacity-100" : "opacity-0"
                  }`}>
                <div className="flex gap-3 flex-row">
                  <a href="https://m.me/gian.gicaraya?hash=AbZ3qt91NOnxS25j&source=qr_link_share" target="_blank" className="p-1 md:p-2 rounded-full border-white border md:border-2">
                    <svg viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" className="w-5 sm:w-6 h-5 sm:h-6">
                  ...
                  <a href="tel:+639279022504" target="_blank" className="p-1 md:p-2 rounded-full border-white border md:border-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="w-5 sm:w-6 h-5 sm:h-6" strokeLinejoin="round">
              ...
              <div className="bg-[#162022] p-6 absolute w-2/5 md:w-1/3 right-0 top-0"> <span></span></div>
              <div className="rounded-t-3xl bg-[#0E161B] p-8 absolute w-2/5 md:w-1/3 right-[40%] md:right-1/3 -mr-12 top-0">
                <div>
                  <Image
                    alt="Gian Paolo Gicaraya's Resume"
                    fill
              ...
              <div className="rounded-b-3xl bg-[#162022] p-2 absolute w-2/5 md:w-1/3 -right-12 top-12"> <span></span></div>
            </div>
            <div className={`flex flex-row items-center gap-3 md:gap-6 transition-all relative mb-8 md:mb-20 max-w-[80%] ${isVisible ? "animate-slideDown opacity-100" : "opacity-0"
                  }`}>
              <div className="avatar online">
                <div className="relative h-16 sm:h-20 md:h-40 max-w-40 w-full mx-auto rounded-full">
                  <Image
                    alt="Gian Paolo Gicaraya's Resume"
                    fill
              ...
              <div className="flex flex-col gap-1 md:gap-2">
                <h1 className="text-lg md:text-3xl leading-tight font-bold text-left max-w-48 md:max-w-full">
            ...
            <div>
              <div className={`chat chat-start delay-300 opacity-0 ${isVisible ? "animate-slideInLeft opacity-100" : "opacity-0"
                  }`}>
                <div className="chat-bubble shadow-lg transition-all bg-[#1E3A8A] text-white text-left ">
                  Hi there! I&apos;m Gian Paolo Gicaraya, a versatile front-end web developer who thrives on tackling challenges head-on.
                </div>
              </div>
              <div className={`chat chat-start delay-1000 opacity-0 ${isVisible ? "animate-slideInLeft opacity-100" : "opacity-0"
                  }`}>
                <div className="chat-bubble shadow-lg transition-all bg-[#1E3A8A] text-white text-left ">
                  Quick to adapt, eager to learn — let&apos;s create something amazing together!
                </div>
              </div>
            </div>

            <div className="mt-10">
              <PulsatingArrows link="#secondFoldSectionWrapper" />
            </div>
          </div>
        </div>
      </GradientBackground>
