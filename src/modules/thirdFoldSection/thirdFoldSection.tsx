...
interface ThirdFoldSectionSectionProps {
  className?: string
}

const ThirdFoldSection: React.FC<ThirdFoldSectionSectionProps> = ({ className }) => {
  const [isVisible, setIsVisible] = useState(false);
  const sectionRefThree = useRef<HTMLDivElement>(null);

  useEffect(() => {
    const sectionElement = sectionRefThree.current; // Capture the current ref value
  ...
  return (
    <div className={cn(`section secondFoldSection ${className}`)} id="thirdFoldSectionWrapper" ref={sectionRefThree}>
      <GradientBackground
      ...
      >
        <div className="absolute inset-0">
          <Image
            ...
            src="/images/pexels-nickoloui-2473183.jpg"
            unoptimized
            loading="lazy"
          />
        </div>
        ...
        <div className={`max-w-7xl mx-auto shadow-2xl bg-slate-500/40 w-full relative z-10 ${isVisible ? "animate-slideDown opacity-100" : "animate-slideOutUp opacity-0"
          }`}>
          <div className="flex flex-col md:flex-row px-6 md:gap-10 realtive">
            <div className="flex flex-col justify-between items-start text-left gap-4 basis-1/2 py-10 md:py-20 md:pl-4 relative z-20">
              ...
              <div className="text-center  md:text-left">
                Explore a detailed showcase of my skills, experience, and projects in a beautifully crafted resume.
              </div>
              <div className="flex justify-center w-full md:justify-start">
                <Link href="/resume" className="flex flex-row justify-center md:justify-end items-center transition-all bg-white py-3 pl-4 md:hover:pl-10 pr-4 text-slate-800 text-sm gap-3 font-bold">
            ...
            <div className="basis-1/2 md:relative transition-all">
              <div className="absolute inset-0 block w-full md:h-[120%] md:-mt-[5%] md:-mr-[5%]">
                ...
                <div className="stack">
                  <Image
                    src="/images/closeup-candidate-giving-his-cv-while-applying-job-office.jpg"
                    fill
                    alt="Gian Paolo Gicaraya's Resume"
...
export default ThirdFoldSection